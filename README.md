...
[![codecov](https://codecov.io/gh/libra-finance/libra-contract/branch/master/graph/badge.svg?token=CI26SD9SGE)](https://codecov.io/gh/libra-finance/libra-contract)
[![CI](https://github.com/libra-finance/libra-contract/workflows/CI/badge.svg)](https://github.com/libra-finance/libra-contract/actions?query=workflow%3ACI)

The smart contracts behind [libra.finance](https://libra.finance) 🤠
...
The output in the `docs` folder should be copied to the appropriate folder in the [libra-docs repo](https://github.com/libra-finance/libra-docs/tree/master/solidity-docs).
