...
import "./core/CoreRefUpgradeable.sol";
 ...
 * deployment size.
 */
contract Swap is CoreRefUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @notice Withdraw all admin fees
     */
    function withdrawAdminFees(address to) external onlyGovernor {
        swapStorage.withdrawAdminFees(to);
    }
     ...
     */
    function setAdminFee(uint256 newAdminFee) external onlyGovernor {
     ...
     */
    function setSwapFee(uint256 newSwapFee) external onlyGovernor {
     ...
     */
    function rampA(uint256 futureA, uint256 futureTime) external onlyGovernor {
